...
<template>
  <span style="display:inline-flex;align-items:center;gap:0.5em">
    ...
    >
      ...
      <path :fill="`url(#${uid})`" d="M 430,112 C 452,222 362,470 230,470 A 200,200 0 0 1 30,270 C 30,78 172,8 430,112 Z" />
    ...
    <span v-if="showWordmark" :style="wordmarkStyle">Job<span style="color:#818CF8">Applica</span></span>
  </span>
</template>
