...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('Open', 'Closed', 'Pending', name='jobstatus'), nullable=False),
        sa.Column('position', sa.Enum('Intern', 'Junior', 'Mid', 'Senior', 'Lead', 'Manager', name='jobposition'), nullable=True),
        ...
        sa.Column('work_model', sa.Enum('On-site', 'Remote', 'Hybrid', name='jobworkmodel'), nullable=False),
