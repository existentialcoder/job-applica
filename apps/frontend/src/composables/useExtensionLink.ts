...
const CHROME_URL =
  'https://chromewebstore.google.com/detail/job-applica-tracker/pdeohjoaoidbbjlnbmcfccokiblckhcg';
...
export function useExtensionLink() {
  ...
  const storeUrl = computed(() => (browser.value === 'firefox' ? FIREFOX_URL : CHROME_URL));
